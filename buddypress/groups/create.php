...
<div id="buddypress">
    ...
    <form action="<?php bp_group_creation_form_action(); ?>" method="post" id="create-group-form" class="standard-form" enctype="multipart/form-data">
        ...
        <div class="item-list-tabs no-ajax connect-item-list-tabs connect-single-item-list-tabs" id="group-create-tabs" role="navigation">
            <ul>
        ...
        <div class="item-body" id="group-create-body">
            ...
            <?php if ( bp_is_group_creation_step( 'group-details' ) ) : ?>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="group-name" id="group-name" aria-required="true" value="<?php bp_new_group_name(); ?>" class="form-control" />
                </div>

                <div class="form-group">
                    <label for="group-desc"><?php _e( 'Group Description (required)', 'buddypress' ); ?></label>
                    <textarea name="group-desc" id="group-desc" aria-required="true" class="form-control"><?php bp_new_group_description(); ?></textarea>
                </div>
            ...
            <?php if ( bp_is_group_creation_step( 'group-settings' ) ) : ?>
                ...
                <div class="radio">
                    <div class="radio" style="margin-bottom: 5px;"><label><input type="radio" name="group-status" value="public"<?php if ( 'public' == bp_get_new_group_status() || !bp_get_new_group_status() ) { ?> checked="checked"<?php } ?> /> <strong><?php _e( 'This is a public group', 'buddypress' ); ?></strong></label></div>
                    <ul>
            ...
            <?php if ( bp_is_group_creation_step( 'group-avatar' ) ) : ?>
                ...
                <?php if ( 'upload-image' == bp_get_avatar_admin_step() ) : ?>
                    ...
                    <div class="left-menu pull-left" style="margin: 0 15px 15px 0;">
                    ...
                    <div class="main-column">
                        ...
                        <p>
                            ...
                            <input type="submit" class="btn btn-primary connect-btn connect-btn-primary" name="upload" id="upload" value="<?php esc_attr_e( 'Upload Image', 'buddypress' ); ?>" />
                ...
                <?php if ( 'crop-image' == bp_get_avatar_admin_step() ) : ?>
                    ...
                    <input type="submit" class="btn btn-primary connect-btn connect-btn-primary" name="avatar-crop-submit" id="avatar-crop-submit" value="<?php esc_attr_e( 'Crop Image', 'buddypress' ); ?>" />
            ...
            <?php if ( 'crop-image' != bp_get_avatar_admin_step() ) : ?>
                ...
                <div class="submit" id="previous-next">
                    ...
                    <?php if ( !bp_is_first_group_creation_step() ) : ?>
                        ...
                        <input type="button" class="btn btn-default connect-btn connect-btn-default" value="<?php esc_attr_e( 'Back to Previous Step', 'buddypress' ); ?>" id="group-creation-previous" name="previous" onclick="location.href = '<?php bp_group_creation_previous_link(); ?>'" />
                    ...
                    <?php if ( !bp_is_last_group_creation_step() && !bp_is_first_group_creation_step() ) : ?>
                        ...
                        <input type="submit" class="btn btn-primary connect-btn connect-btn-primary" value="<?php esc_attr_e( 'Next Step', 'buddypress' ); ?>" id="group-creation-next" name="save" />
                    ...
                    <?php if ( bp_is_first_group_creation_step() ) : ?>
                        ...
                        <input type="submit" class="btn btn-primary connect-btn connect-btn-primary" value="<?php esc_attr_e( 'Create Group and Continue', 'buddypress' ); ?>" id="group-creation-create" name="save" />
                    ...
                    <?php if ( bp_is_last_group_creation_step() ) : ?>
                        ...
                        <input type="submit" class="btn btn-primary connect-btn connect-btn-primary" value="<?php esc_attr_e( 'Finish', 'buddypress' ); ?>" id="group-creation-finish" name="save" />
