...
<form action="<?php bp_group_admin_form_action(); ?>" name="group-settings-form" id="group-settings-form" class="standard-form" method="post" enctype="multipart/form-data">
    ...
    <?php if ( bp_is_group_admin_screen( 'edit-details' ) ) : ?>
        ...
        <p><input type="submit" value="<?php esc_attr_e( 'Save Changes', 'buddypress' ); ?>" id="save" name="save" class="btn btn-primary connect-btn connect-btn-primary" /></p>
    ...
    <?php if ( bp_is_group_admin_screen( 'manage-members' ) ) : ?>
        ...
        <div class="bp-widget">
            ...
            <?php if ( bp_has_members( '&include=' . bp_group_admin_ids() ) ) : ?>
                <div class="members dir-list manage-members">
    ...
    <?php if ( bp_is_group_admin_screen( 'delete-group' ) ) : ?>
        ...
        <div class="checkbox">
            ...
            <label><input type="checkbox" name="delete-group-understand" id="delete-group-understand" value="1" onclick="if ( this.checked ) {
                    ...
                    }" /> <?php _e( 'I understand the consequences of deleting this group.', 'buddypress' ); ?></label>
        </div>
        ...
        <div class="submit">
            <input type="submit" disabled="disabled" class="btn btn-default connect-btn connect-btn-primary" value="<?php esc_attr_e( 'Delete Group', 'buddypress' ); ?>" id="delete-group-button" name="delete-group-button" />
        </div>
