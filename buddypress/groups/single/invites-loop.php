...
<div class="main-column">
    ...
    <?php if ( bp_group_has_invites( bp_ajax_querystring( 'invite' ) . '&per_page=10' ) ) : ?>
        ...
        <div id="pag-top" class="pagination connect-pagination connect-pagination-top">
            ...
            <ul id="friend-list" class="item-list">
                ...
                <?php while ( bp_group_invites() ) : bp_group_the_invite(); ?>
                    ...
                    <li id="<?php bp_group_invite_item_id(); ?>">
                        ...
                        <div class="item">
                            <h4 class="item-name"><?php bp_group_invite_user_link(); ?></h4>
                        ...
                        <div class="action">
                            <a class="button remove btn btn-default connect-btn connect-btn-default" href="<?php bp_group_invite_user_remove_invite_url(); ?>" id="<?php bp_group_invite_item_id(); ?>"><?php _e( 'Remove Invite', 'buddypress' ); ?></a>
        ...
        <div id="pag-bottom" class="pagination connect-pagination connect-pagination-top">
