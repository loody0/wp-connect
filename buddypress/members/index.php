...
<div id="buddypress">
    ...
    <form action="" method="post" id="members-directory-form" class="dir-form">
        ...
        <div class="item-list-tabs connect-item-list-tabs" role="navigation">
            <ul>
    ...
    <form action="" method="post" id="members-directory-form-2" class="dir-form">
            ...
            <ul>
                ...
                <li id="members-order-select" class="last filter">
                    <div class="connect-order-select-wrap">
                        <select id="members-order-by" class="form-control connect-order-select">
