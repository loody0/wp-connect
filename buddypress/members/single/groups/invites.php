...
<?php if ( bp_has_groups( 'type=invites&user_id=' . bp_loggedin_user_id() ) ) : ?>
    <div class="members dir-list groups-invites">
        ...
        <ul id="group-list" class="invites item-list">
            ...
            <?php while ( bp_groups() ) : bp_the_group(); ?>
                ...
                <li>
                    ...
                    <div class="action">
                        <a class="button accept btn btn-primary connect-btn connect-btn-primary" href="<?php bp_group_accept_invite_link(); ?>"><?php _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
                        <a class="button reject confirm btn btn-default connect-btn connect-btn-default" href="<?php bp_group_reject_invite_link(); ?>"><?php _e( 'Reject', 'buddypress' ); ?></a>
...
<?php else: ?>
    ...
    <div id="message" class="info alert-info">
