    ...
    while ( bp_profile_groups() ) : bp_the_profile_group();
        ...
        <form action="<?php bp_the_profile_group_edit_form_action(); ?>" method="post" id="profile-edit-form" class="standard-form <?php bp_the_profile_group_slug(); ?>">
            ...
            <?php if ( bp_profile_has_multiple_groups() ) : ?>
                <div class="connect-item-list-tabs single-item-list-tabs">
                    <ul class="button-nav">
            ...
            <div class="submit">
                <input type="submit" class="btn btn-primary connect-btn connect-btn-primary" name="profile-group-edit-submit" id="profile-group-edit-submit" value="<?php esc_attr_e( 'Save Changes', 'buddypress' ); ?> " />
            </div>
