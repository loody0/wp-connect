...
<?php if ( bp_has_members( 'type=alphabetical&include=' . bp_get_friendship_requests() ) ) : ?>
    ...
    <div id="pag-top" class="pagination no-ajax connect-pagination connect-pagination-top clearfix">
        ...
        <div class="pag-count pull-left" id="member-dir-count-top">

            <?php bp_members_pagination_count(); ?>

        </div>

        <div class="pagination-links pull-right" id="member-dir-pag-top">
        ...
        <ul id="friend-list" class="item-list">
            <?php while ( bp_members() ) : bp_the_member(); ?>
                ...
                <li id="friendship-<?php bp_friend_friendship_id(); ?>">
                    ...
                    <div class="action">
                        <a class="button accept btn btn-primary connect-btn connect-btn-primary" href="<?php bp_friend_accept_request_link(); ?>"><?php _e( 'Accept', 'buddypress' ); ?></a> &nbsp;
                        <a class="button reject btn btn-default connect-btn connect-btn-default" href="<?php bp_friend_reject_request_link(); ?>"><?php _e( 'Reject', 'buddypress' ); ?></a>
    ...
    <div id="pag-bottom" class="pagination no-ajax connect-pagination clearfix">
        ...
        <div class="pag-count pull-left" id="member-dir-count-bottom">

            <?php bp_members_pagination_count(); ?>

        </div>

        <div class="pagination-links pull-right" id="member-dir-pag-bottom">
