        ...
        <form action="" name="signup_form" id="signup_form" class="standard-form" method="post" enctype="multipart/form-data">
            ...
            <?php if ( 'request-details' == bp_get_current_signup_step() ) : ?>
                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="register-section" id="basic-details-section">
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <input type="text" name="signup_username" id="signup_username" value="<?php bp_signup_username_value(); ?>" <?php bp_form_field_attributes( 'username' ); ?> class="form-control"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <input type="email" name="signup_email" id="signup_email" value="<?php bp_signup_email_value(); ?>" <?php bp_form_field_attributes( 'email' ); ?> class="form-control"/>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <input type="password" name="signup_password" id="signup_password" value="" class="password-entry form-control" <?php bp_form_field_attributes( 'password' ); ?> />
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <input type="password" name="signup_password_confirm" id="signup_password_confirm" value="" class="password-entry-confirm form-control" <?php bp_form_field_attributes( 'password' ); ?>/>
                            </div>
                ...
                <?php if ( bp_get_blog_signup_allowed() ) : ?>
                    ...
                    <div class="register-section" id="blog-details-section">
                        ...
                        <div class="form-group">
                            <div class="checkbox"><input type="checkbox" name="signup_with_blog" id="signup_with_blog" value="1"<?php if ( ( int ) bp_get_signup_with_blog_value() ) : ?> checked="checked"<?php endif; ?> /> <?php _e( 'Yes, I\'d like to create a new site', 'buddypress' ); ?></div>
                        </div>
                        ...
                        <div id="blog-details"<?php if ( ( int ) bp_get_signup_with_blog_value() ) : ?>class="show"<?php endif; ?>>
                            ...
                            <div class="form-group">
                                ...
                                ?>
                                <input type="text" name="signup_blog_title" id="signup_blog_title" value="<?php bp_signup_blog_title_value(); ?>" class="form-control" />
                            </div>
                ...
                <div class="submit">
                    <input type="submit" name="signup_submit" id="signup_submit" value="<?php esc_attr_e( 'Complete Sign Up', 'buddypress' ); ?>" class="btn btn-primary connect-btn connect-btn-primary btn-lg" />
                </div>
            ...
            <?php if ( 'completed-confirmation' == bp_get_current_signup_step() ) : ?>
                ...
                <?php if ( bp_registration_needs_activation() ) : ?>
                    <div class="alert alert-info"><?php _e( 'You have successfully created your account! To begin using this site you will need to activate your account via the email we have just sent to your address.', 'buddypress' ); ?></div>
                <?php else : ?>
                    <div class="alert alert-info"><?php _e( 'You have successfully created your account! Please log in using the username and password you have just created.', 'buddypress' ); ?></div>
                <?php endif; ?>
